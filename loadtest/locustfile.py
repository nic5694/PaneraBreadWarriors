...
class ApiWorkflow(SequentialTaskSet):
    ...
    def on_start(self):
        ...
        with self.client.post(
            ...
            name="POST /events/v1/api/events/",
            catch_response=True,
        ) as response:
            if response.status_code != 201:
                response.failure(
    ...
    def _list_users(self):
        self.client.get("/users/v1/api/users/", name="GET /users/v1/api/users/")

    def _get_user(self):
        self.client.get(
            f"/users/v1/api/users/{self.user_id}",
            name="GET /users/v1/api/users/:id",
        )
    ...
    def _update_user(self):
        ...
        self.client.patch(
            f"/users/v1/api/users/{self.user_id}",
            json=update_payload,
            name="PATCH /users/v1/api/users/:id",
        )
    ...
    def on_stop(self):
        self.client.delete(
            f"/users/v1/api/users/{self.user_id}",
            name="DELETE /users/v1/api/users/:id",
        )
